...
export class Train {
  ...
  trainVersion(appId: string, versionId: string, options?: msRest.RequestOptionsBase, callback?: msRest.ServiceCallback<Models.EnqueueTrainingResponse>): any {
  ...
  getStatus(appId: string, versionId: string, options?: msRest.RequestOptionsBase, callback?: msRest.ServiceCallback<Models.ModelTrainingInfo[]>): any {
