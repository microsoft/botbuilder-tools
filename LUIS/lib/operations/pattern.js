...
class Pattern {
    ...
    addPattern(azureRegion, appId, versionId, pattern, options, callback) {
        ...
        let cb = callback;
        if (!callback) {
            return this.addPatternWithHttpOperationResponse(azureRegion, appId, versionId, pattern, options).then((operationRes) => {
            ...
            msRest.promiseToCallback(this.addPatternWithHttpOperationResponse(azureRegion, appId, versionId, pattern, options))((err, data) => {
                if (err) {
                    return cb(err);
                }
    ...
    getPatterns(azureRegion, appId, versionId, options, callback) {
        ...
        let cb = callback;
        if (!callback) {
            return this.getPatternsWithHttpOperationResponse(azureRegion, appId, versionId, options).then((operationRes) => {
                return Promise.resolve(operationRes.bodyAsJson);
            }).catch((err) => {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.getPatternsWithHttpOperationResponse(azureRegion, appId, versionId, options))((err, data) => {
                if (err) {
                    return cb(err);
                }
                let result = data.bodyAsJson;
    ...
    updatePatterns(azureRegion, appId, versionId, patterns, options, callback) {
        ...
        let cb = callback;
        if (!callback) {
            return this.updatePatternsWithHttpOperationResponse(azureRegion, appId, versionId, patterns, options).then((operationRes) => {
                return Promise.resolve(operationRes.bodyAsJson);
            }).catch((err) => {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.updatePatternsWithHttpOperationResponse(azureRegion, appId, versionId, patterns, options))((err, data) => {
                if (err) {
                    return cb(err);
                }
                let result = data.bodyAsJson;
    ...
    batchAddPatterns(azureRegion, appId, versionId, patterns, options, callback) {
        ...
        let cb = callback;
        if (!callback) {
            return this.batchAddPatternsWithHttpOperationResponse(azureRegion, appId, versionId, patterns, options).then((operationRes) => {
                return Promise.resolve(operationRes.bodyAsJson);
            }).catch((err) => {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.batchAddPatternsWithHttpOperationResponse(azureRegion, appId, versionId, patterns, options))((err, data) => {
                if (err) {
                    return cb(err);
                }
                let result = data.bodyAsJson;
    ...
    deletePatterns(azureRegion, appId, versionId, patternIds, options, callback) {
        ...
        let cb = callback;
        if (!callback) {
            return this.deletePatternsWithHttpOperationResponse(azureRegion, appId, versionId, patternIds, options).then((operationRes) => {
                return Promise.resolve(operationRes.bodyAsJson);
            }).catch((err) => {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.deletePatternsWithHttpOperationResponse(azureRegion, appId, versionId, patternIds, options))((err, data) => {
                if (err) {
                    return cb(err);
                }
                let result = data.bodyAsJson;
    ...
    updatePattern(azureRegion, appId, versionId, patternId, pattern, options, callback) {
        ...
        let cb = callback;
        if (!callback) {
            return this.updatePatternWithHttpOperationResponse(azureRegion, appId, versionId, patternId, pattern, options).then((operationRes) => {
                return Promise.resolve(operationRes.bodyAsJson);
            }).catch((err) => {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.updatePatternWithHttpOperationResponse(azureRegion, appId, versionId, patternId, pattern, options))((err, data) => {
                if (err) {
                    return cb(err);
                }
                let result = data.bodyAsJson;
    ...
    deletePattern(azureRegion, appId, versionId, patternId, options, callback) {
        ...
        let cb = callback;
        if (!callback) {
            return this.deletePatternWithHttpOperationResponse(azureRegion, appId, versionId, patternId, options).then((operationRes) => {
                return Promise.resolve(operationRes.bodyAsJson);
            }).catch((err) => {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.deletePatternWithHttpOperationResponse(azureRegion, appId, versionId, patternId, options))((err, data) => {
                if (err) {
                    return cb(err);
                }
                let result = data.bodyAsJson;
    ...
    getIntentPatterns(azureRegion, appId, versionId, intentId, options, callback) {
        ...
        let cb = callback;
        if (!callback) {
            return this.getIntentPatternsWithHttpOperationResponse(azureRegion, appId, versionId, intentId, options).then((operationRes) => {
                return Promise.resolve(operationRes.bodyAsJson);
            }).catch((err) => {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.getIntentPatternsWithHttpOperationResponse(azureRegion, appId, versionId, intentId, options))((err, data) => {
                if (err) {
                    return cb(err);
                }
                let result = data.bodyAsJson;
