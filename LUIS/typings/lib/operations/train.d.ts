...
export declare class Train {
     ...
     */
    trainVersionWithHttpOperationResponse(appId: string, versionId: string, options?: msRest.RequestOptionsBase): Promise<msRest.HttpOperationResponse<Models.EnqueueTrainingResponse>>;
    /**
     ...
     * @reject {Error|ServiceError} The error object.
     */
    getStatusWithHttpOperationResponse(appId: string, versionId: string, options?: msRest.RequestOptionsBase): Promise<msRest.HttpOperationResponse<Models.ModelTrainingInfo[]>>;
    /**
     * Sends a training request for a version of a specified LUIS app. This POST request initiates a
     * request asynchronously. To determine whether the training request is successful, submit a GET
     * request to get training status. Note: The application version is not fully trained unless all
     ...
     */
    trainVersion(appId: string, versionId: string): Promise<Models.EnqueueTrainingResponse>;
    trainVersion(appId: string, versionId: string, options: msRest.RequestOptionsBase): Promise<Models.EnqueueTrainingResponse>;
     ...
     *                      {HttpOperationResponse} [response] - The HTTP Response stream if an error did not occur.
     */
    getStatus(appId: string, versionId: string): Promise<Models.ModelTrainingInfo[]>;
    getStatus(appId: string, versionId: string, options: msRest.RequestOptionsBase): Promise<Models.ModelTrainingInfo[]>;
