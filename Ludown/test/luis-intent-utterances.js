...
describe('LUIS intent and utterances concepts in .lu files', function() {
    it('should be parsed correctly when 1 intent and 1 entity is specified', function() {
        return parseFileContents.parseFile(testcases.tests["1-intent-1-entity"].lufile,false,'en-us')
    ...
    it('should be parsed correctly when 1 intent and labelled utterances is specified', function() {
        return parseFileContents.parseFile(testcases.tests["1-intent-labelled-utterances"].lufile,false,'en-us')
            .then(function(parsedContent) {
                assert.deepEqual(
                    parsedContent.LUISJsonStructure, 
    ...
    it('should be parsed correctly when 1 intent and prebuilt entity is specified', function() {
        return parseFileContents.parseFile(testcases.tests["1-intent-prebuilt-entity"].lufile,false,'en-us')
            .then(function(parsedContent) {
                assert.deepEqual(
                    parsedContent.LUISJsonStructure, 
    ...
    it('should be parsed correctly when 1 intent is specified', function() {
        return parseFileContents.parseFile(testcases.tests["1-intent"].lufile,false,'en-us')
            .then(function(parsedContent) {
                assert.deepEqual(
                    parsedContent.LUISJsonStructure, 
    ...
    it('should be parsed correctly when 2 intents and scattered list entity definition is specified', function() {
        return parseFileContents.parseFile(testcases.tests["2-intent-scattered-list"].lufile,false,'en-us')
            .then(function(parsedContent) {
                assert.deepEqual(
                    parsedContent.LUISJsonStructure, 
    ...
    it('should be parsed correctly when 2 intents is specified', function() {
        return parseFileContents.parseFile(testcases.tests["2-intent"].lufile,false,'en-us')
            .then(function(parsedContent) {
                assert.deepEqual(
                    parsedContent.LUISJsonStructure, 
