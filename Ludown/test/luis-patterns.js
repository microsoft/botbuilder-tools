...
describe('LUIS patterns concepts in .lu files', function() {
    it('should be parsed correctly when 1 intent 1 list entity is specified', function() {
        assert.deepEqual(
            parseFileContents.parseFile(testcases.tests["1-intent-pattern-list"].lufile,false,'en-us').LUISJsonStructure, 
    ...
    it('should be parsed correctly when 1 intent 1 pattern.any entity is specified', function() {
        assert.deepEqual(
            parseFileContents.parseFile(testcases.tests["1-intent-pattern-patternAny"].lufile,false,'en-us').LUISJsonStructure, 
    ...
    it('should be parsed correctly when 3 intents as patterns is specified', function() {
        assert.deepEqual(
            parseFileContents.parseFile(testcases.tests["3-intents-patterns"].lufile,false,'en-us').LUISJsonStructure, 
