...
var symbolicNames = [ null, "WS", "NEWLINE", "QNA", "HASH", "DASH", "DOLLAR", 
                      "COMMENT", "IMPORT_DESC", "IMPORT_PATH", "Filter_MARK", 
...
LUFileParser.RULE_commentDefinition = 29;
...
ParagraphContext.prototype.commentDefinition = function() {
    return this.getTypedRuleContext(CommentDefinitionContext,0);
};
...
function CommentDefinitionContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = LUFileParser.RULE_commentDefinition;
    return this;
}

CommentDefinitionContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
CommentDefinitionContext.prototype.constructor = CommentDefinitionContext;

CommentDefinitionContext.prototype.COMMENT = function() {
    return this.getToken(LUFileParser.COMMENT, 0);
};

CommentDefinitionContext.prototype.enterRule = function(listener) {
    if(listener instanceof LUFileParserListener ) {
        listener.enterCommentDefinition(this);
	}
};

CommentDefinitionContext.prototype.exitRule = function(listener) {
    if(listener instanceof LUFileParserListener ) {
        listener.exitCommentDefinition(this);
	}
};

CommentDefinitionContext.prototype.accept = function(visitor) {
    if ( visitor instanceof LUFileParserVisitor ) {
...
LUFileParser.CommentDefinitionContext = CommentDefinitionContext;

LUFileParser.prototype.commentDefinition = function() {

    var localctx = new CommentDefinitionContext(this, this._ctx, this.state);
    this.enterRule(localctx, 58, LUFileParser.RULE_commentDefinition);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 219;
        this.match(LUFileParser.COMMENT);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
